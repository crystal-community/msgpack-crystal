...
describe "MessagePack::Packer" do
  ...
  it_packs(-0x8000, UInt8[0xD1, 0x80, 0x00])
  it_packs(-0x80000000, UInt8[0xD2, 0x80, 0x00, 0x00, 0x00])
  it_packs(-9223372036854775808, UInt8[0xD3, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])

  it_packs(1.to_u8, UInt8[0x01])
  it_packs(128.to_u8, UInt8[0xCC, 0x80])
  it_packs(0xFFFF, UInt8[0xCD, 0xFF, 0xFF])
  it_packs(0xFFFFFFFF, UInt8[0xCE, 0xFF, 0xFF, 0xFF, 0xFF])
  it_packs(18446744073709551615_u64, UInt8[0xCF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])
